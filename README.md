...
This repository contains  a sample of how to integrate a Panther Grid screen with Bootstrap Datatables. IT also demostrates a JQuery Click event on a row.
